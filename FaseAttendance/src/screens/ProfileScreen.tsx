...
//     work_permit_expiry?: string; // ISO date string
//     project_name?: string;
//     project_role?: string;
...
//         setProfile(data); // null is fine - UI handles it
//         setLoadingProfile(false);
//     };
...
//             'To update your personal details, please contact your supervisor or HR. This request will be sent to admin.'
//         );
//         // Future: apiService.requestProfileEdit(empid)
//     };
...
//                     </Text>
//                 </View>
//                 <Text style={styles.userName}>{profile?.full_name || userData?.username || 'User Name'}</Text>
...
//                             <Text style={[styles.badgeText, styles.badgeActiveText]}>{profile.status}</Text>
//                         </View>
//                     )}
//                 </View>
//                 {profile?.joined_date && (
//                     <Text style={styles.joinedText}>Joined: {profile.joined_date}</Text>
//                 )}
//             </View>
...
//                             : `Work Permit expires in ${wpDays} day(s) (${profile?.work_permit_expiry}). Please renew soon.`}
//                     </Text>
//                 </View>
//             )}
...
//                     <Text style={styles.sectionTitle}>Personal & Employment Details</Text>
//                     <TouchableOpacity onPress={handleRequestEdit}>
//                         <Text style={styles.requestEditText}>Request Edit</Text>
//                     </TouchableOpacity>
//                 </View>

//                 <DetailRow label="IC / Passport No." value={profile?.ic_passport_no} />
//                 <DetailRow label="Contact Number" value={profile?.contact_number} />
//                 <DetailRow label="Email" value={profile?.email} />
//                 <DetailRow label="Nationality" value={profile?.nationality} />
//                 <DetailRow label="Work Permit No." value={profile?.work_permit_no} />
//                 <DetailRow
//                     label="WP Expiry"
//                     value={profile?.work_permit_expiry}
//                     valueStyle={wpExpired ? styles.errorValue : wpExpiringSoon ? styles.warningValue : undefined}
//                 />
//             </View>

//             {/* Current Project Assignment */}
//             <View style={styles.sectionCard}>
//                 <Text style={styles.sectionTitle}>Current Project Assignment</Text>
//                 <DetailRow label="Project" value={profile?.project_name} />
//                 <DetailRow label="Role" value={profile?.project_role} />
//                 <DetailRow label="Supervisor" value={profile?.supervisor_name} />
//                 <DetailRow label="Shift Hours" value={profile?.shift_hours} />
//                 <DetailRow label="Site Address" value={profile?.site_address} />
//             </View>
...
//                     <StatBox value={profile?.attendance_summary?.days_present ?? '--'} label="Present" color="#28a745" />
//                     <StatBox value={profile?.attendance_summary?.days_absent ?? '--'} label="Absent" color="#dc3545" />
//                     <StatBox value={profile?.attendance_summary?.days_late ?? '--'} label="Late" color="#ff7a1a" />
//                     <StatBox
//                         value={profile?.attendance_summary?.attendance_rate != null ? `${profile.attendance_summary.attendance_rate}%` : '--'}
//                         label="Rate"
//                         color="#007bff"
//                     />
//                 </View>
//                 <DetailRow label="Last Check-In" value={profile?.attendance_summary?.last_check_in} />
//                 <DetailRow label="Last Check-Out" value={profile?.attendance_summary?.last_check_out} />
...
//             {/* Face Enrollment */}
//             <View style={styles.sectionCard}>
//                 <Text style={styles.sectionTitle}>Mobile App Access</Text>
...
//     profileInfo: { alignItems: 'center', marginTop: -40, marginBottom: 15 },
//     avatarLarge: {
//         width: 100, height: 100, borderRadius: 50, backgroundColor: '#ffd400',
//         alignItems: 'center', justifyContent: 'center', borderWidth: 4, borderColor: '#fff',
//         shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 3,
//     },
//     avatarLargeText: { fontSize: 48, fontWeight: 'bold', color: '#fff' },
//     userName: { fontSize: 24, fontWeight: 'bold', color: '#343a40', marginTop: 15 },
//     userEmpId: { fontSize: 16, color: '#6c757d', marginTop: 5 },
//     userRole: { fontSize: 14, color: '#007bff', marginTop: 5, fontWeight: '500' },
//     badgeRow: { flexDirection: 'row', gap: 8, marginTop: 10 },
//     badge: { backgroundColor: '#e9ecef', paddingHorizontal: 12, paddingVertical: 4, borderRadius: 12 },
...
//     warningBanner: {
//         marginHorizontal: 20, marginBottom: 15, backgroundColor: '#fff4e6',
//         padding: 14, borderRadius: 12, flexDirection: 'row', alignItems: 'center', gap: 10,
//         borderLeftWidth: 4, borderLeftColor: '#ff7a1a',
//     },
//     errorBanner: { backgroundColor: '#fdecea', borderLeftColor: '#dc3545' },
//     warningText: { flex: 1, color: '#b35900', fontSize: 13 },
//     errorText: { color: '#dc3545' },

//     sectionCard: {
//         marginHorizontal: 20, marginBottom: 15, backgroundColor: '#fff', padding: 18, borderRadius: 15,
//         shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 4, elevation: 2,
//     },
//     sectionHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
//     sectionTitle: { fontSize: 16, fontWeight: 'bold', color: '#343a40', marginBottom: 12 },
//     requestEditText: { color: '#007bff', fontSize: 13, fontWeight: '600' },

//     detailRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6, borderBottomWidth: 1, borderBottomColor: '#f1f3f5' },
//     detailLabel: { fontSize: 13, color: '#6c757d', flex: 1 },
//     detailValue: { fontSize: 13, color: '#343a40', fontWeight: '500', flex: 1, textAlign: 'right' },
//     warningValue: { color: '#ff7a1a', fontWeight: 'bold' },
//     errorValue: { color: '#dc3545', fontWeight: 'bold' },
...
//     linkRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10, paddingTop: 10, borderTopWidth: 1, borderTopColor: '#f1f3f5' },
//     linkText: { color: '#007bff', fontSize: 14, fontWeight: '600' },

//     certRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: '#f1f3f5' },
//     certInfo: { flex: 1 },
//     certName: { fontSize: 14, fontWeight: '500', color: '#343a40' },
//     certExpiry: { fontSize: 11, color: '#6c757d', marginTop: 2 },
//     certBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10, backgroundColor: '#e9ecef' },
//     certValid: { backgroundColor: '#d4edda' },
//     certExpiringSoon: { backgroundColor: '#fff4e6' },
//     certExpired: { backgroundColor: '#fdecea' },
//     certBadgeText: { fontSize: 11, fontWeight: '600', color: '#495057' },

//     emptyText: { fontSize: 13, color: '#adb5bd', textAlign: 'center', paddingVertical: 10 },

//     menuItem: {
//         flexDirection: 'row', alignItems: 'center', backgroundColor: '#f8f9fa', padding: 12, borderRadius: 12, marginBottom: 8,
//     },
//     menuIcon: { width: 40, alignItems: 'center' },
//     menuContent: { flex: 1, marginLeft: 10 },
//     menuText: { fontSize: 15, fontWeight: '500', color: '#343a40' },
//     menuSubtext: { fontSize: 12, color: '#6c757d', marginTop: 2 },

//     appInfo: { alignItems: 'center', paddingVertical: 20, marginBottom: 20 },
//     appVersion: { fontSize: 12, color: '#6c757d' },
//     copyright: { fontSize: 12, color: '#6c757d', marginTop: 5 },
// });
