...
const styles = StyleSheet.create({
    ...
    statLabel: { fontSize: 11, color: '#6c757d', marginTop: 4 },
    ...
    leaveDates: { fontSize: 12, color: '#6c757d', marginTop: 3 },
    ...
    stepPillText: { fontSize: 11, fontWeight: '700', color: '#6c757d' },
    ...
    calendarLegendText: { fontSize: 11, color: '#6c757d' },
    subTabBar: {
