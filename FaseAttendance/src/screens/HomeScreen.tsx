            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.clockCard}>
                    ...
                    <View style={styles.clockIconWrap}>
                        <Ionicons name="time-outline" size={26} color="#212c6b" />
                    </View>
                </View>
                                ...
                                <View key={item.id} style={styles.historyCard}>
                                    <View style={styles.historyCardHeader}>
                                        ...
                                        <View
                                            style={[
                                                ...
                                                { backgroundColor: item.isCheckedOut ? '#20c99733' : '#212c6b33' },
                                            ]}
                                        >
                                            <Text
                                                style={[
                                                    styles.historyStatusText,
                                                    { color: item.isCheckedOut ? '#20c997' : '#212c6b' },
                                                ]}
                                            >
                                    ...
                                    <View style={styles.historyBoxRow}>
                                        <View style={styles.historyBox}>
                                            <Ionicons name="calendar-outline" size={15} color="#212c6b" />
...
const styles = StyleSheet.create({
    ...
    sectionLink: { fontSize: 12, fontWeight: '600', color: '#212c6b' },
